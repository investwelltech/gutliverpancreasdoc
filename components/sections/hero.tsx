...
export function Hero() {
  ...
  return (
    <section className="relative overflow-hidden bg-warm-white">
      ...
      <div className="relative mx-auto grid max-w-[1240px] gap-y-8 px-5 pb-14 pt-8 sm:px-6 sm:pb-16 sm:pt-10 lg:grid-cols-[55fr_45fr] lg:items-start lg:gap-x-14 lg:gap-y-5 lg:px-8 lg:pb-24 lg:pt-20">
        {/* ---------------- Copy ---------------- */}
        ...
        <div className="relative order-2 mx-auto aspect-[3/4] w-full max-w-[300px] overflow-hidden rounded-sm sm:max-w-[340px] lg:col-start-2 lg:row-span-3 lg:row-start-1 lg:max-w-[420px]">
          <Image
            src={img.src}
            alt={img.alt}
            fill
        ...
        {/* ---------------- Medical animation ---------------- */}
        {/* Sits under the copy on desktop rather than under the photograph, and
            stays after the photograph on mobile. Kept deliberately narrow so it
            supports the portrait rather than competing with it. */}
        <VideoLoop
          src={motion.medical.src}
          label={motion.medical.label}
          className="order-3 mx-auto aspect-video w-full max-w-[240px] overflow-hidden sm:max-w-[280px] lg:col-start-1 lg:row-start-2 lg:mx-0 lg:max-w-[260px]"
        ...
        <p className="order-4 text-[0.8125rem] uppercase tracking-[0.14em] text-teal lg:col-start-1 lg:row-start-3">
